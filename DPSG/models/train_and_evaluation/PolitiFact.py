...
neighbor_dict = neighbor_loader('../../data/rwr_results/fnn_politifact_n5_p5_u100/n_neighbors.txt')

with open("../../data/rwr_results/fnn_politifact_n5_p5_u100/original_adj",'r',encoding='utf-8') as f:
...
post_nodes = data_loader(
    pathway='../../data/processed_data/FakeNewsNet/politifact/fnn_politifact_n5_p5_u100/normalized_post_nodes/',
    node_type="post")
user_nodes = data_loader(
    pathway='../../data/processed_data/FakeNewsNet/politifact/fnn_politifact_n5_p5_u100/normalized_user_nodes/',
    node_type="user")
news_nodes = data_loader(
    pathway='../../data/processed_data/FakeNewsNet/politifact/fnn_politifact_n5_p5_u100/normalized_news_nodes/',
    node_type="news")
news_emb_dict = {}
post_emb_dict = {}
user_emb_dict = {}
