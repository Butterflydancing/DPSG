...
def data_loader(pathway='../../data/processed_data/PHEME/pheme_n5_p5_u100/normalized_news_nodes/', node_type="news"):
    if node_type == "news":
        news_node = []
        news_id = []
        news_label = []
...
with open("../../data/rwr_results/pheme_n5_p5_u100/original_adj",'r',encoding='utf-8') as f:
    adj_list=json.load(f)

neighbor_dict = neighbor_loader('../../data/rwr_results/pheme_n5_p5_u100/n_neighbors.txt')
post_nodes = data_loader(pathway='../../data/processed_data/PHEME/pheme_n5_p5_u100/normalized_post_nodes/',
    node_type="post")
news_nodes = data_loader(pathway='../../data/processed_data/PHEME/pheme_n5_p5_u100/normalized_news_nodes/',
                         node_type="news")
user_nodes = data_loader(pathway='../../data/processed_data/PHEME/pheme_n5_p5_u100/normalized_user_nodes/',
    node_type="user")
